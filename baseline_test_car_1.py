...
class World(object):
    ...
    def restart(self, args):
        ...
        while self.player is None:
            ...
            custom_location = carla.Location(x=26, y=60, z=0.5)
        ...
        while True:
            ...
            if subscriber.receive_messages():
                ...
                try:
                    ...
                    # To stop the vehicle, set throttle and brake appropriately
                ...
                if sent:
                    ...
                    if True:
                    #final_occupancy_grid is not None:
                        print('Control side: Doing Hybrid Astar on the new grid')
                        ...
                        np.save("baseline_grid/baseline_occupancygrid1.npy", baseline_occupancygrid)
                        new_path = path = hybrid_astar.path_finder(player_x, player_y-3, player_yaw, destination_x, destination_y, destination_yaw, baseline_occupancygrid)

                        # # Post-process new_path.x values based on the decimal part
                        # processed_x = []
                        # for x in new_path.x:
                        #     x_float = float(x)
                        #     decimal = x_float - int(x_float)
                        #     if decimal < 0.25:
                        #         processed_x.append(int(x_float))
                        #     elif 0.25 <= decimal < 0.75:
                        #         processed_x.append(int(x_float) + 0.5)
                        #     else:
                        #         processed_x.append(math.ceil(x_float))
                        # new_path.x = processed_x
