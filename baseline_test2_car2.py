            ...
            if subscriber.receive_messages():
                ...
                if sent:
                    ...
                    if final_occupancy_grid is not None:
                        ...
                        updated_path = hybrid_astar.path_finder2(player_x, player_y+2, player_yaw, new_destination_point[0], new_destination_point[1], destination_yaw, baseline_occupancygrid)
