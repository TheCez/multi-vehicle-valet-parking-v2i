...
from conflict_solver.solver3 import ConflictSolver
import os
import queue
import argparse
import csv
                    ...
                    if msg_type == b"ACK":
                        ...
                        if self.conflict_counter == 0:
                            ...
                            if conflict_mask.any():
                                ...
                                new_path_point, waypoint_og = self.conflict_solver.solve_conflict(vis_grid , min_r, min_c)

                                conflict_area[conflict_area == 2] = 1
                                conflict_area[conflict_area != 1] = 0
                                ...
                                visualization_grid_view[waypoint_og[0], waypoint_og[1]] = 7
