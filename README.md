...
| Field | Value |
|---|---|
| Archive branch | `thesis/valet-parking-workspace` |
| Variant | Map, grid-generation, and standalone valet-parking workspace |
...
git switch thesis/valet-parking-workspace
