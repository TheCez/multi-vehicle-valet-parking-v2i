...
| Field | Value |
|---|---|
| Archive branch | `thesis/all-car-reachability` |
| Variant | Reachability and occupancy grids calculated for all vehicles |
| CARLA map | `Town_Valet_Parking` |
| Python | 3.10 |
...
git switch thesis/all-car-reachability
...
Install or import `Town_Valet_Parking`, start the CARLA server, and then run:
