...
| Field | Value |
|---|---|
| Archive branch | `thesis/all-car-reachability-parking-lines` |
| Variant | All-car reachability with visible parking-line map |
| CARLA map | `Town_Valet_Parking_Lines` |
| Python | 3.10 |
...
git switch thesis/all-car-reachability-parking-lines
...
Install or import `Town_Valet_Parking_Lines`, start the CARLA server, and then run:
