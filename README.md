...
| Field | Value |
|---|---|
| Archive branch | `thesis/all-car-reachability-new-map` |
| Variant | All-car reachability strategy on the final map |
...
git switch thesis/all-car-reachability-new-map
